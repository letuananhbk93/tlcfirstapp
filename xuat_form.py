...
# Form implementation generated from reading ui file 'xuat_form_vi.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.xuatkhoButton = QtWidgets.QPushButton(Form)
        self.xuatkhoButton.setObjectName("xuatkhoButton")
        self.gridLayout.addWidget(self.xuatkhoButton, 1, 2, 1, 1)
        ...
        self.capnhatxuatkButton = QtWidgets.QPushButton(Form)
        self.capnhatxuatkButton.setObjectName("capnhatxuatkButton")
        self.gridLayout.addWidget(self.capnhatxuatkButton, 2, 2, 2, 1)
        ...
        Form.setTabOrder(self.lineEdit_10, self.xuatkhoButton)
        Form.setTabOrder(self.xuatkhoButton, self.capnhatxuatkButton)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "EXPORT WAREHOUSE"))
        self.label_2.setText(_translate("Form", "THÔNG TIN"))
        self.label_3.setText(_translate("Form", "Ngày"))
        self.xuatkhoButton.setText(_translate("Form", "XUẤT KHO"))
        self.label_4.setText(_translate("Form", "Số PO"))
        self.capnhatxuatkButton.setText(_translate("Form", "CẬP NHẬT"))
        self.label_5.setText(_translate("Form", "Tên Crate"))
        self.label_6.setText(_translate("Form", "Ship to"))
        self.label_7.setText(_translate("Form", "Số Order"))
        self.label_9.setText(_translate("Form", "SKU"))
        self.label_10.setText(_translate("Form", "Product"))
        self.label_11.setText(_translate("Form", "Color"))
        self.label_12.setText(_translate("Form", "Qty"))
        self.label_13.setText(_translate("Form", "Note"))
import resources_rc
