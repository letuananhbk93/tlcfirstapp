...
# Form implementation generated from reading ui file 'nhap_form_vi.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.nhapkhoButton = QtWidgets.QPushButton(Form)
        self.nhapkhoButton.setObjectName("nhapkhoButton")
        self.gridLayout.addWidget(self.nhapkhoButton, 1, 2, 1, 1)
        ...
        self.capnhatnhapkButton = QtWidgets.QPushButton(Form)
        self.capnhatnhapkButton.setObjectName("capnhatnhapkButton")
        self.gridLayout.addWidget(self.capnhatnhapkButton, 2, 2, 2, 1)
        ...
        Form.setTabOrder(self.lineEdit_15, self.nhapkhoButton)
        Form.setTabOrder(self.nhapkhoButton, self.capnhatnhapkButton)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "IMPORT WAREHOUSE"))
        self.label_2.setText(_translate("Form", "THÔNG TIN"))
        self.label_3.setText(_translate("Form", "Ngày"))
        self.nhapkhoButton.setText(_translate("Form", "NHẬP KHO"))
        self.label_4.setText(_translate("Form", "Số kiện"))
        self.capnhatnhapkButton.setText(_translate("Form", "CẬP NHẬT"))
        self.label_5.setText(_translate("Form", "SKU"))
        self.label_18.setText(_translate("Form", "Tên Hàng"))
        self.label_6.setText(_translate("Form", "COLOR1"))
        self.label_7.setText(_translate("Form", "COLOR"))
        self.label_9.setText(_translate("Form", "Qty"))
        self.label_10.setText(_translate("Form", "Số PO"))
        self.label_11.setText(_translate("Form", "Dài"))
        self.label_12.setText(_translate("Form", "Rộng"))
        self.label_13.setText(_translate("Form", "Cao"))
        self.label_14.setText(_translate("Form", "Trọng lượng"))
        self.label_15.setText(_translate("Form", "CBM"))
        self.label_16.setText(_translate("Form", "Supplier"))
        self.label_17.setText(_translate("Form", "Note"))
import resources_rc
